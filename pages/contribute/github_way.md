...
1. Go to the [ELIXIR Training SPLASH repo](https://github.com/elixir-europe-training/ELIXIR-Training-SPLASH) on GitHub.
...
4. You can always return to your opened issue by going to the [issues section](https://github.com/elixir-europe-training/ELIXIR-Training-SPLASH/issues) of our GitHub repo.

{% include callout.html type="tip" content="You can also get to the [ELIXIR Training SPLASH pages](https://github.com/elixir-europe-training/ELIXIR-Training-SPLASH) on GitHub using the 'GitHub' link in the header of this site" %}
...
1. You can return to your pull request by going to the [pull request section](https://github.com/elixir-europe-training/ELIXIR-Training-SPLASH/pulls) of our GitHub repo.
